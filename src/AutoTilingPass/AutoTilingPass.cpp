...
namespace {
    ...
    private:
        bool isCUDAKernel(Function &F) {
            ...
            return name.contains("kernel") || name.contains("Kernel") || name.starts_with("_Z");
        }
        ...
        bool isMonteCarloPattern(Loop *L) {
            ...
            for (BasicBlock *BB : L->blocks()) {
                for (Instruction &I : *BB) {
                    ...
                    if (isa<BinaryOperator>(&I) || isa<BinaryOperator>(&I) || isa<BinaryOperator>(&I) || isa<BinaryOperator>(&I)) {
                        hasComplexMath = true;
                    }
                }
            }
        ...
        bool performTilingTransformation(Function &F, Loop *targetLoop) {
            ...
            Instruction *OrigTerminator = LoopHeader->getTerminator();
